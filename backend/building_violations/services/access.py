...
PERMISSIONS: dict[str, tuple[str, str, list[str]]] = {
    "CASE_VIEW_ALL": ("View cases of all zones (no jurisdiction filter)", "Cases", ["XEN", "VIEWER"]),
    ...
    "DASHBOARD_VIEW": ("View dashboards", "MIS", ["JE", "AE", "XEN", "JC", "JC_CLERK", "FIELD_STAFF", "VIEWER", "BRANCH_OFFICER"]),
    "REPORTS_EXPORT": ("Run and export reports", "MIS", ["AE", "XEN", "JC", "JC_CLERK", "VIEWER"]),
    "AUDIT_VIEW": ("View admin audit log", "MIS", []),
    "PLANS_VIEW": ("View sanctioned plans register", "Masters", ["JE", "AE", "XEN", "JC", "JC_CLERK", "FIELD_STAFF", "VIEWER", "BRANCH_OFFICER"]),
    "PLANS_MANAGE": ("Add / edit / bulk-upload sanctioned plans", "Masters", ["JE", "AE", "XEN", "JC", "BRANCH_OFFICER"]),
    "LAND_LAYERS_MANAGE": ("Upload government-land layers", "Masters", ["BRANCH_OFFICER"]),
    "MASTERS_MANAGE": ("Edit zones / wards / violation types / order types / SLA", "Masters", []),
    "LEGAL_VIEW": ("View legal catalogue", "Masters", ["JE", "AE", "XEN", "JC", "JC_CLERK", "FIELD_STAFF", "VIEWER", "BRANCH_OFFICER"]),
