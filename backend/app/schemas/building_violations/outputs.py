...
def case_detail(db: Session, c, request=None, user=None):
    ...
    d.update({
        ...
        "height_m": c.height_m, "use_observed": c.use_observed, "occupants_total": c.occupants_total, "occupants_senior_citizens": c.occupants_senior_citizens,
        "occupants_children": c.occupants_children, "occupants_women": c.occupants_women, "description": c.description, "measurements": c.measurements, "submitted_at": c.submitted_at,
