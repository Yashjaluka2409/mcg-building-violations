...
export default function CasesScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.bg }}>
      <Header title={p.inbox ? "Inbox" : p.mine ? "My Cases" : "Cases"} subtitle={p.status ? p.status.split(",").map((s: string) => wf.statusLabel(s, s.replace(/_/g, " "))).join(" / ") : "Violation cases in your area"} />
